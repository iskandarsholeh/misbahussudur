...
<body>
    ...
    <section class="container py-5">
        ...
        <div class="row projects gx-lg-5">
                 <?php
                $db_connection = mysqli_connect("localhost","root","","misbahussudur");
                $select = mysqli_query($db_connection, "SELECT * FROM work");
                while ($row = $select->fetch_assoc()) {                         
                ?>
            <a  href="work-single.php?id=<?php echo $row['id']; ?>" class="col-sm-6 col-lg-4 text-decoration-none project marketing social business">
                <div class="service-work overflow-hidden card mb-5 mx-5 m-sm-0">
                    <img class="card-img-top" src="admin-master/img/<?php echo $row['foto']; ?>" alt="...">
                    <div class="card-body">
                        <h5 class="card-title light-300 text-dark"><?php echo $row['judul']; ?></h5>
